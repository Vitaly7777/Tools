...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.radio_smb_to_unc = QRadioButton("SMB в UNC (Из Samba в Windows)")
        # Горизонтальные layout для радио
        radio1_layout = QHBoxLayout()  # Создаем горизонтальный layout для радио
        radio2_layout = QHBoxLayout()  # Создаем горизонтальный layout для радио
